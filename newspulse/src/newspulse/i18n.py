...
_EN: dict[str, str] = {
    ...
    "kommt keines davon vor, ist es nicht diese Firma": "if none of these occurs, it is not this company",
    "Actions pro Quartal": "Actions per quarter",
    "vertraglich zugesichert": "contractually agreed",
    "leer = nichts hinterlegt": "blank = nothing on file",
